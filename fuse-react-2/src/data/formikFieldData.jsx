...
export const newsCreateFormInputs = [
  {
    title: "Title",
    description:
      "You can update or create title in three different languages (EN, AZ, RU).",
    type: "text",
    isLang: true,
    id: "title",
    name: "title",
  },
  {
    title: "Description",
    description:
      "You can update or create description in three different languages (EN, AZ, RU).",
    type: "text",
    isLang: true,
    id: "description",
    name: "description",
...
export const ecosystemFormInitialValues = {
  titleEn: "",
  titleRu: "",
  titleAz: "",
  descriptionEn: "",
...
export const ecosystemCreateFormInputs = [
  ...
  {
    title: "Tag Country",
    description: "Select appropriate country",
    type: "select",
    isLang: false,
    id: "country",
    name: "tagCountry",
  ...
  {
    title: "Tag Profile",
    description: "Select appropriate profile",
    type: "select",
    isLang: false,
    id: "profile",
    name: "tagProfile",
  ...
  {
    title: "Tag Industry",
    description: "Select appropriate industry",
    type: "select",
    isLang: false,
    id: "industry",
    name: "tagIndustry",
...
export const ecosystemTagsInitialValues = {
  tagCountry: "",
  tagProfile: "",
  tagIndustry: [],
};
    ...
    inputs: [
      {
        ...
        description: "Enter appropriate social url",
        type: "text",
        id: "url",
        name: "url",
      },
      {
        ...
        description: "Select appropriate social url",
        type: "select",
        options: medias,
        id: "type",
        name: "type",
    ...
    inputs: [
      {
        ...
        description: "Enter appropriate title",
        type: "text",
        id: "title",
        name: "title",
      },
      {
        title: "Latest News description",
        description: "Select appropriate description",
        type: "text",
        id: "description",
        name: "description",
      },
...
export const useInfoPortalForm = () => {
  return {
    ...
    inputs: [
      {
        title: "Website Name",
        description: "Enter appropriate website name",
        type: "text",
        id: "websiteName",
        name: "websiteName",
      },
      {
        ...
        description:
          "Enter appropriate information description in the place of INFORMATION PORTAL in real website",
        type: "text",
        id: "infoDescription",
      ...
      },
      {
        ...
        description:
          "Enter appropriate copyright messsage. Note: You don't need to add '©', it will automatically be added to the website.",
        type: "text",
        id: "copyrightMessage",
